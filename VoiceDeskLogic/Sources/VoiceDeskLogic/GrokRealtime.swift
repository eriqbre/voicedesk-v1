...
public enum GrokRealtime {
    ...
    public static func presenceInstructions(
        ...
        If the body is not there yet, do not say you don't know and do not speak an empty placeholder. Do not invent the body.
        \(context.isConnected
