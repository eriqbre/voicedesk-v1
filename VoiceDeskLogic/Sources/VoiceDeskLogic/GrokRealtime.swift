...
public enum GrokRealtime {
    ...
    public static func presenceInstructions(
        ...
        If they ask for a full email, summary, or body, answer from the facts. If the body is not there yet, wait in this same turn and speak the answer once — do not say you don't know and do not speak an empty placeholder. Do not invent the body.
        \(context.isConnected
